...
def demo_placement_engine():
    ...
    from aws_fleet_scout import recommend_placement, PlacementConstraints
    ...
    try:
        ...
        if options and len(options) > 0:
            ...
            print(f"  Top recommendation: {options[0].region} ({options[0].predicted_stability} stability)")
        ...
        print(f"Constraints: min_score={constraints.min_score_threshold}, allowed_regions={constraints.region_allowlist}")
        
        options = recommend_placement(
            job_spec={"m7i.4xlarge": 10, "c6i.8xlarge": 5},
...
def demo_integration_example():
    ...
    try:
        ...
        job_spec = {
            "m7i.4xlarge": 2,   # Coordinator nodes
            "p5.48xlarge": 4     # GPU training nodes
        }
