...
app = typer.Typer(help="AWS Fleet Scout: Scout the best AWS regions for spot or capacity block deployments")
...
def spot_score(
    ...
    regions: str = typer.Option("", help="Comma-separated AWS regions or wildcards (e.g. us-east-1,us-west-2 or us-* or eu-west-*). If not set, defaults to all us-east-* and us-west-* regions."),
    target_capacity: int = typer.Option(15, help="Target capacity (number of instances) to check for spot placement score."),
    discover_p_series: bool = typer.Option(False, "--discover-p-series", help="Auto-discover P4/P5/P6 GPU instances (shortcut for --discover p)"),
    discover: str = typer.Option("", "--discover", help="Auto-discover instances by prefix (e.g., 'p5' for P5-series, 'g5' for G5-series, 'm7i,c7i' for multiple)"),
    skip_quota_check: bool = typer.Option(False, "--skip-quota-check", help="Skip quota validation (useful if you have pending quota increases)"),
    force_refresh: bool = typer.Option(False, "--force-refresh", help="Force refresh from AWS API, bypass cache (scores cached for 10 minutes)")
):
    """
...
def capacity_find(
    ...
    job_spec: str = typer.Option("", help='JSON string with instance requirements, e.g. \'{"p5.48xlarge": 2}\''),
    ...
    regions: str = typer.Option("", help="Comma-separated AWS regions or wildcards (e.g. us-east-1,us-west-2 or us-*)"),
    discover_p_series: bool = typer.Option(False, "--discover-p-series", help="Auto-discover P4/P5/P6 GPU instances (shortcut for --discover p)"),
    discover: str = typer.Option("", "--discover", help="Auto-discover instances by prefix (e.g., 'p5' for P5-series, 'g5' for G5-series, 'm7i,c7i' for multiple)"),
...
def capacity_calendar(
    ...
    regions: str = typer.Option("", help="Comma-separated AWS regions or wildcards (e.g. us-east-1,us-west-2 or us-*)"),
    discover_p_series: bool = typer.Option(False, "--discover-p-series", help="Auto-discover P4/P5/P6 GPU instances (requires single region)"),
    discover: str = typer.Option("", "--discover", help="Auto-discover instances by prefix (e.g., 'p5', 'g5') - requires single region"),
    output: str = typer.Option("table", help="Output format (json or table)")
):
    """
...
def fleet_pack(
    ctx: typer.Context,
    job_spec: str = typer.Option("", help='JSON string with instance requirements, e.g. \'{"m7i.4xlarge": 20, "p5.48xlarge": 2}\''),
    output: str = typer.Option("json", help="Output format (json or table)"),
    regions: str = typer.Option("", help="Comma-separated AWS regions or wildcards (e.g. us-east-1,us-west-2 or us-*). If not set, defaults to all us-east-* and us-west-* regions.")
):
...
def fleet_recommend(
    ...
    required_families: str = typer.Option("", help="Comma-separated required instance families (e.g., 'm7i,p5')"),
    gpu_families: str = typer.Option("", help="Comma-separated required GPU families (e.g., 'p5,p4d')"),
    network_adjacency: str = typer.Option("", help="Preferred region for network adjacency (e.g., 'us-east-1')"),
    output: str = typer.Option("table", help="Output format (json or table)")
):
    """
...
def compare(
    ...
    regions: str = typer.Option("", help="Comma-separated AWS regions or wildcards (e.g. us-east-1,us-west-2 or us-*)"),
    discover_p_series: bool = typer.Option(False, "--discover-p-series", help="Auto-discover P4/P5/P6 GPU instances (shortcut for --discover p)"),
    discover: str = typer.Option("", "--discover", help="Auto-discover instances by prefix (e.g., 'p' for P-series, 'g' for G-series, 'm7i,c7i' for multiple)"),
    output: str = typer.Option("table", help="Output format (json or table)")
):
    """
