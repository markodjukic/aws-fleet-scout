...
def main(
    ...
    latency_config = LatencyConfig(
        base_region=base_region if base_region else None,
        inter_region_penalty=latency_penalty
    )
    ...
    if output == 'json':
        ...
        # Table format
        console = Console()
        table = Table(title="Composite Utility Rankings", show_header=True, header_style="bold magenta")
